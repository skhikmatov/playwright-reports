...
- text: Name
- textbox "Name": Failing Test User
- text: Email
- textbox "Email": failing@test.com
- text: Phone
- textbox "Phone": "+12345678901"
- text: Subject
- textbox "Subject": This test will fail
- text: Message
- textbox: This is a test message that will lead to a failure at the end.
- button "Submit"
- contentinfo:
